...
def train_one_epoch(model, data, loss, epoch, optimizer, scaler, scheduler, dist_model, args, tb_writer=None, sbert=None):
...
def evaluate(model, data, loss, epoch, args, tb_writer=None, sbert=None):
    metrics = {}
